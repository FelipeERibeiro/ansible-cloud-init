...
<li>Extra: Pesquisar sobre inodes.</li>
...
<ol>
<p>----------------------------------------------------------------------------------------------------</p>
 <p><input type="checkbox">  Criar um novo disco com ao menos 10 MB; </p>
 <p><input type="checkbox">  OPCIONAL: Criar um lvm chamado lv_disco; </p>
 <p><input type="checkbox">  Formatar o novo disco com ext4 e montar em /mnt/teste_deu_boa; </p>
 <p># OBS: Este ponto de montagem deve ser iniciado após um reboot. </p>
 ...
 <p><input type="checkbox">  Com o usuário tux crie um arquivo dentro de dir2 chamado de run.sh e neste arquivo deve constar o seguinte conteudo: </p>
 <p>			#!/bin/bash </p>
 <p>			echo "Uhuul deu boa" </p>
 <p>				# OBS: Teste o script para garantir que ele está rodando e trazendo a informação "Uhuul deu boa". </p>
 <p><input type="checkbox">  Dentro de dir3 criar um arquivo chamado de lista_dir, com uma saida do comando ls /mnt/teste_deu_boa; </p>
 <p>			OPCIONAL: Pesquisar sobre stdin, stdout, stderr. </p>
 <p><input type="checkbox">  Após ter rodado com sucesso remova o usuário tux do grupo linux. </p>
 <p>			OBS: Garanta e entenda o motivo que o usuário tux não consegue mais entrar em /mnt/teste_deu_boa; </p>
 <p>----------------------------------------------------------------------------------------------------</p>
 </body>
</html>
